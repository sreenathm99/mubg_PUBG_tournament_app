...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService  {
    ...
    private void sendNotification(String title,String messageBody, String click_action, String jsmessage) {
        Intent intent;
        if(click_action.equals("SOMEACTIVITY")){

            notresult.urlpass(jsmessage,title);
            intent = new Intent(this, notresult.class);
